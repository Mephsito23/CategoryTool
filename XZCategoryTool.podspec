#
#  Be sure to run `pod spec lint XZCategoryTool.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "mephsito"
  # s.authors            = { "mephsito" => "xiezefu@outlook.com" }
  # s.social_media_url   = "http://twitter.com/mephsito"
